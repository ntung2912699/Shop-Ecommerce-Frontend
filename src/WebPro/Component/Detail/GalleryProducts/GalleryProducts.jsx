                    ...
                    <div className="col-md-7">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <button className="btn" data-bs-toggle="modal" data-bs-target="#image-modal">
                                    <img src={this.props.images.product.thumbnail} className="d-block w-100" alt='....'/>
                                </button>
                            </div>
                            {
                                arr.map((gallery, index)=>{
                                    return <>
                                        <div class="carousel-item">
                                            <button className="btn" data-bs-toggle="modal" data-bs-target="#image-modal">
                                                <img key={index} src={gallery} className="d-block w-100" alt="..."/>
                                            </button>
                                        </div>
                                        <div class="modal fade" id="image-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-xl">
                                                <div><button type="button" class="btn btn-danger" data-bs-dismiss="modal">Đóng X</button></div>
                                                <div class="modal-content">
                                                    <div class="modal-body">
                                                    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                                                        <div class="carousel-inner">
                                                            <div class="carousel-items active">
                                                                <img src={this.props.images.product.thumbnail} class="d-block w-100" alt="..."/>
                                                            </div>
                                                            {
                                                                arr.map((gallery, index)=>{
                                                                return <>
                                                                    <div class="carousel-items">
                                                                        <img key={index} src={gallery}class="d-block w-100" alt="..."/>
                                                                    </div>
                                                                </>  
                                                                })
                                                            }

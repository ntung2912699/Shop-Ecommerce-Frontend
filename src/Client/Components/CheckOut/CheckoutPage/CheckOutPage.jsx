                                ...
                                <ul class="list-group list-group-flush mb-3">
                                {
                                    this.state.products.map((element, index) => {
                                       return <li class="list-group-item d-flex justify-content-between lh-sm">
                                            <div>
                                            <h6 class="my-0 text-truncate" style={{maxWidth : '200px'}}>{element.product.name}</h6>
                                            {
                                ...
                                <div class="shadow p-3 mb-5 bg-body rounded">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-sm-6">
                                            ...
                                            <input type="text" class="form-control" disabled id="firstName" placeholder="" value={e.first_name} required=""/>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input type="text" class="form-control" disabled id="lastName" placeholder="" value={e.last_name} required=""/>
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="col-7">
                                            ...
                                            <input type="email" class="form-control" disabled value={window.localStorage.getItem('email')} id="email"/>
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="col-5">
                                            ...
                                            <input type="number" class="form-control" disabled value={e.phone_number} required=""/>
                                            <div class="invalid-feedback">

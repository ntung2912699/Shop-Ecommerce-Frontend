        ...
        return (
            <section>
                ...
                <div className="col-md-12">
                    <form onSubmit={this.submitProduct} className="form-add">
                        ...
                        <div class="mb-3 row">
                            <div className="col-md-3">
                                ...
                                <div className="col-md-12">
                                <img style={{width:'100px', marginLeft : '-1rem', marginTop : '-1rem', marginBottom : '1rem'}}  src={this.state.thumbnail_review? URL.createObjectURL(this.state.thumbnail_review) : null } />
                                </div>
                            </div>
                            <div class="col-md-9">
                                ...
                                {   
                                    this.state.gallery_preview.map((file, key) => {
                                        return (
                                            <div key={key} className="col-md-3 col-3" style={{marginTop : '20px'}}>
                                                <img style={{minWidth:'100%',maxWidth : '120%', marginLeft : '-1rem', marginTop : '-1rem'}} src={URL.createObjectURL(file)}/>
                                            </div>
                                        )
                                    })
                                }
